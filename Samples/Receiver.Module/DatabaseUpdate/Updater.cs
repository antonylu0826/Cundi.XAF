...
using Receiver.Module.BusinessObjects;

namespace Receiver.Module.DatabaseUpdate;

/// <summary>
/// Database updater for the Receiver module.
/// Creates default admin user and roles on first run.
/// </summary>
